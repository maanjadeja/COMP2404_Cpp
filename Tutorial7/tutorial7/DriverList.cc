...
bool DriverList::get(const string& name, Driver** foundDriver){ //should the parameters be consts? as in the spec it does not say so
    Node * currNode;
...
bool DriverList::findRide(int rating, Size size, Location location, Driver** d){
